...
2. **Draft the Milestone Specification**:
   ...
   - Create a markdown file exactly at: `.cyclestone/milestones/{{ID_PREFIX}}-<optimized_slug>/{{ID_PREFIX}}-specification.md`
   - The milestone ID must start with the four-digit prefix followed by a hyphen and the optimized slug, for example `0001-project-setup` (with its spec file named `0001-specification.md`).
